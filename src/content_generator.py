...
class ContentGenerator:
    ...
    def generate_dialogue_script(self, raw_news_context: str, recent_topics: List[str] = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "4. FORMAT & TURN STRUCTURE: Format strictly line-by-line using speaker labels: 'Alex: ...' and 'Sarah: ...'. Structure the episode into 12 to 16 rich, substantial alternating turns where each host speaks a complete, insightful paragraph (approx. 80-110 words per turn) before handing over to the co-host.\n"
